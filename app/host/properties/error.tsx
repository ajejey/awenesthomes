...
export default function HostPropertiesError({
  error,
  reset,
}: {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="bg-white shadow-md rounded-lg p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          We encountered an error while loading your properties. Please try again or contact support if the problem persists.
        </p>
